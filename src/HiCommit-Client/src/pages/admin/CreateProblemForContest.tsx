...
import { getContestByID, getContestByIDForAdmin } from "@/service/API/Contest";
...
function CreateProblemForContest() {
    ...
    const handleCreateProblem = async () => {
        ...
        try {
            ...
            setTimeout(() => {
                navigate(`/admin/contests/${contest_id}`);
            }, 500);
    ...
    return (
        <div className="CreateProblemForContest p-5 pl-2 flex flex-col gap-8">
            <Breadcrumb>
                <BreadcrumbList>
                    <BreadcrumbItem>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink asChild>
                            <Link to={`/admin/contests/${contest?.id}`}>{contest?.name || "..."}</Link>
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
...
export default CreateProblemForContest;
